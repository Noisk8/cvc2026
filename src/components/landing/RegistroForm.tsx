...
export default function RegistroForm() {
    ...
    const validateForm = () => {
        ...
        if (!registro.nombre || !registro.apellido || !registro.identificacion || !registro.edad || !registro.email || !registro.telefono || !registro.pais || !registro.ciudad || !registro.genero || !registro.organizacion || !registro.actividad_principal || !registro.participacion_previa || !registro.anos_cvc || !registro.etnia || !registro.rol || !registro.descripcion || !registro.sede || !registro.aporte || (requireCarta && !registro.carta_aval) || !registro.aporte_minga) {
